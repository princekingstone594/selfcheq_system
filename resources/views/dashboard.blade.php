            ...
            <div class="relative p-6 sm:p-8 lg:p-10">
                ...
                <div class="mt-6" x-data="{ show: false }">
                    <button @click="show = !show"
                            :title="show ? 'Hide focus' : 'View focus'"
                        ...
                        <svg x-show="!show" class="h-5 w-5 transition-transform group-hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                        </svg>
                        <svg x-show="show" class="h-5 w-5 transition-transform group-hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="display:none;">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.542 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                        </svg>
                        <span x-text="show ? 'Hide focus' : 'Today\'s focus'"></span>
                    </button>
                    <div x-show="show" x-transition class="mt-4 inline-block rounded-2xl border border-indigo-400/30 bg-indigo-500/10 p-5 text-sm text-indigo-100 backdrop-blur-sm" style="display:none;">
                        <p class="font-semibold">Today's focus</p>
                        <p class="mt-2 text-2xl font-bold">{{ $taskCompleted }}/{{ $taskTotal }} tasks completed</p>
